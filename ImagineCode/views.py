...
class TakeProduct(generics.UpdateAPIView):
    ...
    def post(self, request, *args):
        ...
        if instruction.box_id == take_json.get("id") and instruction.name == take_json.get("name") and instruction.quantity == take_json.get("quantity") and instruction.action == "take":
            instruction.delete()
